...
set t_Co=256 ruler laststatus=2 number nofoldenable relativenumber title tabstop=2 softtabstop=2 expandtab  shiftwidth=2 smarttab cursorline list listchars=tab:â–¸\ ,trail:>,eol:Â¬ clipboard=unnamed,  nocompatible
